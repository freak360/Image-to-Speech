...
def story(scenario):
    ...
    model = HuggingFaceHub(huggingfacehub_api_token=HUGGINGFACEHUB_API_TOKEN,
                            repo_id=model_id, model_kwargs={"temperature": 0.8, "max_length": 100})
    template = """
    you are a story teller;
    you can generate a short story based on simple narrative, the story should be no more than 50 words.
    CONTEXT: {scenario}
    STORY: 
    """
